...
function Inquiry() {
            ...
            const nights =  checkIn && checkOut ? Math.max(0, Math.ceil((new Date(checkOut) - new Date(checkIn)) / (1000 * 60 * 60 * 24)))
            : 0
            ...
            const handleSubmit = async (e) => {
                    e.preventDefault()
                    console.log('handleSubmit fired', { checkIn, checkOut, guests, hasKids, kidsAges })
                    setFormError('')
               ...
               setSubmitting(true)
                ...
                console.log('createBooking succeeded')
                setResult('success')
                } catch (err) {
